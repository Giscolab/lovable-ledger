...
const categoryColors: Record<CategoryType, string> = {
  ...
  electricity: 'hsl(50, 80%, 50%)',
  water: 'hsl(200, 80%, 50%)',
  insurance: 'hsl(200, 70%, 50%)',
  home_insurance: 'hsl(195, 70%, 50%)',
  internet: 'hsl(170, 70%, 45%)',
  mobile: 'hsl(175, 70%, 45%)',
  ...
  beauty: 'hsl(330, 70%, 60%)',
  gifts: 'hsl(350, 70%, 55%)',
  hobbies: 'hsl(270, 60%, 55%)',
  travel: 'hsl(190, 70%, 50%)',
  bank_fees: 'hsl(220, 30%, 50%)',
  taxes: 'hsl(40, 50%, 45%)',
  donations: 'hsl(0, 60%, 55%)',
  unexpected: 'hsl(45, 90%, 50%)',
  other: 'hsl(220, 15%, 50%)',
};
